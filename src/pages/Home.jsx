...
const Home = () => {
  ...
  useEffect(()=>{
    let url= `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=844780d83b2dcaf1e4037bb286af2ced`;
    if(search){
      url = `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=844780d83b2dcaf1e4037bb286af2ced`
    }
    fetch(url)
